...
setInput::setInput()
{
	...
	AddOption("data-period", "period of data", data_period);
	AddOption("insertion-time", "time to insert a rod", insertion_time);
	AddOption("wait-time", "time break between inserting two rods", wait_time);
	AddOption("total-rods", "total number of inserted rods", total_rods);
	AddOption("boundary-iter", "iteration for boundary condition", boundary_iter);
	AddOption("external-flow", "external flow", external_flow);
	AddOption("flow-period", "period of flow", flow_period);
	AddOption("radiusofSphere", "radius of a sphere", radiusofSphere);
	AddOption("port", "port to connect python", port);
	...
	AddOption("filename", "name of backup file", filename);
	AddOption("currt", "current time", currt);
